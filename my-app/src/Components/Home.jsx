      ...
      <Col>
        <Card className="Cards_tank">
          ...
          <Card.Body className="Card_body">
            ...
            <Card.Text>
              Изменения вносятся изменения в статью Гражданского кодекса в части
              расширения перечня охраняемых результатов интеллектуальной
      ...
      <Col>
        <Card className="Cards_tank">
          ...
          <Card.Body className="Card_body">
            ...
            <Card.Text>
              В абсолютных цифрах показатель составил 187,1 миллиарда иен (1,45
              миллиарда долларов). Между тем экспорт в том же месяце сократился
              на 69,3 процента — 23,77 миллиарда иен (184,2 миллиона долларов).
            </Card.Text>
            <Card.Footer>
              <small className="text-muted">Last updated 3 mins ago</small>
            </Card.Footer>
        ...
        <Card className="Cards_tank">
          ...
          <Card.Body className="Card_body">
            ...
            <Card.Text>
              ...
              стране. Блок призвал остальные партии и организации присоединиться
              к Оппозиционной платформе.
            </Card.Text>
            <Card.Footer>
              <small className="text-muted">Last updated 3 mins ago</small>
            </Card.Footer>
